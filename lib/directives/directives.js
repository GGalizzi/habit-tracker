...
.directive('htProgress', function(Habits, LevelConstants) {
  return {
    restrict: 'E',
    scope: {
      habit: '='
    ...
    link: function(scope, elem, attrs) {
      scope.$watchCollection('habit', function(val) {
        elem.css('width', val.points*100/LevelConstants.PointsNeeded(val.level)+"px");
      });
    }
  };
});
